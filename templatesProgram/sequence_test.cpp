...
#include "sequence4.h"  // With value_type defined as double
using namespace std;
...
void show_sequence(sequence<double> display);
...
int main_test()
{
    sequence<double> test; // A sequence that w’ll perform tests on
