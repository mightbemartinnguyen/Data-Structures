...
namespace main_savitch_10
{
	...
	public:
		...
		binary_tree_node*& left() { return left_field; } // Updated from binary_tree_node* left( )
		binary_tree_node*& right() { return right_field; } // Updated binary_tree_node* right( )
