...
//  Statistician
//
//  Created by Howard Miller on 2/17/19.
//  Copyright © 2019, 2020, 2021 Howard Miller. All rights reserved.//
//
...
int main()
{
    ...
    cerr << "\nYOUR RESULTS:\n";
    cerr << "You have successfully earned " << value << " points out of a possile 90 points.\n\n";
    cerr << "If you submit the statistician to Canvas now, this part of the\n";
    cerr << "grade could be as high as " << static_cast <int> (value / 90.0f * 10.0f) << " points out of 10 points.\n\n";  // Auto Grader has 90 points possible
    return EXIT_SUCCESS;
